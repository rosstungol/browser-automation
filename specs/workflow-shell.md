Create a WorkflowShell component in src/features/workflows/components/ that takes a workflowId and is the layout shell for the workflow editor, then render it from the workflow page.tsx at src/app/(dashboard)/workflows/[id]/page.tsx.
